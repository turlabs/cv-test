...
def findFeatures(img):
    ...
    #imgT= cv2.drawKeypoints(img,keypoints,img,color=(255,0,255))
    imgT= cv2.drawKeypoints(img,keypoints,img)

    cv2.imwrite('sift_keypoints.png', imgT)
...
def main():
    ...
    if img1 is not None and img2 is not None:
        ...
        matchImg = cv2.drawMatches(img1,kp1,img2,kp2,matches,inliers)
...
# python Homography.py --threshold 0.60 data/012-204.jpg data/013-221.jpg